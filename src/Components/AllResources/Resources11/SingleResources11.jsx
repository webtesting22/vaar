    ...
    const boxData = [
        {
            ...
            Description: "One of the primary challenges in real estate investment is the significant amount of capital required to purchase a property. Discreit addresses this by enabling fractional ownership, allowing investors to buy and own a fraction of a property. This means that instead of having to fund the entire property purchase, investors can now contribute a smaller amount proportional to their desired ownership percentage."
        },
        {
            heading: "Diversification Within Real Assets",
            Description: "Real estate diversification is essential for risk management, but it has traditionally been challenging for individual investors with limited capital. Discreit's fractionalization model enables investors to diversify their real estate portfolio by owning fractions of multiple properties. This portfolio approach helps spread the risk across different assets, reducing the impact of underperformance in any single property."
        },
        {
            heading: "Access to Annuity Income and Passive Returns",
            Description: "Fractional ownership on Discreit goes beyond merely owning a piece of a property; it also grants investors access to annuity income generated by the property. This income, often in the form of rental returns, is distributed to investors in proportion to their ownership. By providing a steady stream of passive income, Discreit transforms real estate into an accessible and attractive option for a broader range of investors."
        }
    ]
    return (
        <>
            <CommonResourceComponent Resources="Resources" Module="Module 4" Chapter="Concept 1" Date="February 17, 2023" ResourceHeading="Fractionalization & Discreit " AuthorInfo="Stephanie Gordon, Content Manager, Vaar" topResourceImg={ReactangleTopImage} />
                    ...
                    <Row>
                        ...
                        <Col lg={18} md={18} className="full-width-on-mobile">
                            <div className="resources-right-container">
                                <p>Discreit's innovative approach to real estate investment revolves around the concept of fractionalization, a game-changing mechanism that transforms the traditional real estate investment model. Fractionalization, in the context of Discreit, refers to the division of ownership of a property into smaller, more manageable units, allowing multiple investors to collectively own a share of the asset.
                                    <br /><br />
                                    Traditionally, investing in real estate required a substantial upfront capital investment, often limiting participation to high-net-worth individuals or institutional investors. Discreit disrupts this norm by breaking down the barriers to entry through fractionalization. Here's how the concept works:</p>
